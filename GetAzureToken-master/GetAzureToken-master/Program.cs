...
namespace CSharp_TranslateSample
{
    class Program
    {
        private const string SubscriptionKey = "6afb60386af6477fb37cd2e8e8ed242a";   //Enter here the Key from your Microsoft Translator Text subscription on http://portal.azure.com
